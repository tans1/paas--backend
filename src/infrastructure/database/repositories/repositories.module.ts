...
@Module({
  providers: [AdminRepositoryService, AuthRepositoryService, ProjectsRepositoryService, ServersRepositoryService, UsersRepositoryService, GithubRepositoryService]
})
